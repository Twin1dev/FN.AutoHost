...
namespace FN.AutoHost.Classes
{
    public class Gui : Overlay
    {
        ...
        {
            ImGui.Begin("AutoHoster");
            ImGui.SetWindowSize(new System.Numerics.Vector2(400, 400));

            ImGui.BeginTabBar("WindowTabBar");


            if (ImGui.TabItemButton("Main"))
            {
                TAB = 1;
            }
